<?php /* Smarty version 2.6.14, created on 2016-05-25 10:17:42
		...
		<?php $this->_tag_stack[] = array('CWContenedor', array()); $_block_repeat=true;smarty_block_CWContenedor($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php $this->_tag_stack[] = array('CWTabla', array('conCheck' => 'true','conCheckTodos' => 'true','id' => 'Tabla1','numFilasPantalla' => '10','datos' => $this->_tpl_vars['smty_datosTabla'])); $_block_repeat=true;smarty_block_CWTabla($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
				<?php $this->_tag_stack[] = array('CWFila', array('tipoListado' => 'false')); $_block_repeat=true;smarty_block_CWFila($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
					<?php echo smarty_function_CWCampoTexto(array('nombre' => 'lis_idarticulo','oculto' => 'true','value' => $this->_tpl_vars['defaultData_Articulo']['lis_idarticulo'],'dataType' => $this->_tpl_vars['dataType_Articulo']['lis_idarticulo']), $this);?>
					...
					<?php echo smarty_function_CWAreaTexto(array('textoAsociado' => 'Descripcion','nombre' => 'lis_descripcion','size' => '30','editable' => 'true','visible' => 'true','value' => $this->_tpl_vars['defaultData_Articulo']['lis_descripcion'],'dataType' => $this->_tpl_vars['dataType_Articulo']['lis_descripcion']), $this);?>
					...
					<?php echo smarty_function_CWCampoTexto(array('textoAsociado' => 'Ruta de la imagen','nombre' => 'lis_imagen','size' => '20','editable' => 'true','visible' => 'true','value' => $this->_tpl_vars['defaultData_Articulo']['lis_imagen'],'dataType' => $this->_tpl_vars['dataType_Articulo']['lis_imagen']), $this);?>
					...
					<?php echo smarty_function_CWCampoTexto(array('textoAsociado' => 'Categoria','nombre' => 'lis_categoria','size' => '20','editable' => 'true','visible' => 'true','value' => $this->_tpl_vars['defaultData_Articulo']['lis_categoria'],'dataType' => $this->_tpl_vars['dataType_Articulo']['lis_categoria']), $this);?>
			...
			<?php $this->_tag_stack[] = array('CWFichaEdicion', array('id' => 'FichaEdicion','datos' => $this->_tpl_vars['smty_datosFicha'])); $_block_repeat=true;smarty_block_CWFichaEdicion($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?> 
				<?php $this->_tag_stack[] = array('CWFicha', array()); $_block_repeat=true;smarty_block_CWFicha($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
					...
					<table class="text" cellspacing="4" cellpadding="4" border="0">
						...
						<tr>
							<td><?php echo smarty_function_CWAreaTexto(array('textoAsociado' => 'Descripcion','nombre' => 'edi_descripcion','size' => '0','editable' => 'true','visible' => 'true','value' => $this->_tpl_vars['defaultData_Articulo']['edi_descripcion'],'dataType' => $this->_tpl_vars['dataType_Articulo']['edi_descripcion']), $this);?>
</td>
						</tr>
						<tr>
