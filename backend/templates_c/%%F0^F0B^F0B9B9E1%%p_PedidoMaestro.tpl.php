<?php /* Smarty version 2.6.14, created on 2016-05-25 10:24:42
         compiled from Pedidos/p_PedidoMaestro.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'CWVentana', 'Pedidos/p_PedidoMaestro.tpl', 1, false),array('block', 'CWBarra', 'Pedidos/p_PedidoMaestro.tpl', 2, false),array('block', 'CWMarcoPanel', 'Pedidos/p_PedidoMaestro.tpl', 5, false),array('block', 'CWPanel', 'Pedidos/p_PedidoMaestro.tpl', 9, false),array('block', 'CWBarraSupPanel', 'Pedidos/p_PedidoMaestro.tpl', 10, false),array('block', 'CWContenedor', 'Pedidos/p_PedidoMaestro.tpl', 14, false),array('block', 'CWFicha', 'Pedidos/p_PedidoMaestro.tpl', 15, false),array('block', 'CWBarraInfPanel', 'Pedidos/p_PedidoMaestro.tpl', 27, false),array('block', 'CWTabla', 'Pedidos/p_PedidoMaestro.tpl', 38, false),array('block', 'CWFila', 'Pedidos/p_PedidoMaestro.tpl', 39, false),array('block', 'CWContenedorPestanyas', 'Pedidos/p_PedidoMaestro.tpl', 57, false),array('function', 'CWMenuLayer', 'Pedidos/p_PedidoMaestro.tpl', 3, false),array('function', 'CWBotonTooltip', 'Pedidos/p_PedidoMaestro.tpl', 11, false),array('function', 'CWCampoTexto', 'Pedidos/p_PedidoMaestro.tpl', 18, false),array('function', 'CWBoton', 'Pedidos/p_PedidoMaestro.tpl', 28, false),array('function', 'CWPaginador', 'Pedidos/p_PedidoMaestro.tpl', 47, false),array('function', 'CWPestanya', 'Pedidos/p_PedidoMaestro.tpl', 58, false),)), $this); ?>
		...
		<?php $this->_tag_stack[] = array('CWContenedor', array()); $_block_repeat=true;smarty_block_CWContenedor($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php $this->_tag_stack[] = array('CWTabla', array('conCheck' => 'true','conCheckTodos' => 'false','id' => 'Tabla1','numFilasPantalla' => '6','datos' => $this->_tpl_vars['smty_datosTablaM'])); $_block_repeat=true;smarty_block_CWTabla($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
				<?php $this->_tag_stack[] = array('CWFila', array('tipoListado' => 'false')); $_block_repeat=true;smarty_block_CWFila($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
					<?php echo smarty_function_CWCampoTexto(array('textoAsociado' => 'Fecha del pedido','nombre' => 'lis_fecha','size' => '0','editable' => 'true','visible' => 'true','value' => $this->_tpl_vars['defaultData_PedidoMaestro']['lis_fecha'],'dataType' => $this->_tpl_vars['dataType_PedidoMaestro']['lis_fecha']), $this);?>
					...
					<?php echo smarty_function_CWCampoTexto(array('textoAsociado' => "Nº DNI",'nombre' => 'lis_dni','size' => '9','editable' => 'true','visible' => 'true','value' => $this->_tpl_vars['defaultData_PedidoMaestro']['lis_dni'],'dataType' => $this->_tpl_vars['dataType_PedidoMaestro']['lis_dni']), $this);?>

					<?php echo smarty_function_CWCampoTexto(array('textoAsociado' => 'Cliente','nombre' => 'lis_nombre','size' => '20','editable' => 'true','visible' => 'true','value' => $this->_tpl_vars['defaultData_PedidoMaestro']['lis_nombre'],'dataType' => $this->_tpl_vars['dataType_PedidoMaestro']['lis_nombre']), $this);?>


					<?php echo smarty_function_CWCampoTexto(array('nombre' => 'lis_idpedido','oculto' => 'true','value' => $this->_tpl_vars['defaultData_PedidoMaestro']['lis_idpedido'],'dataType' => $this->_tpl_vars['dataType_PedidoMaestro']['lis_idpedido']), $this);?>
	...
	<?php $this->_tag_stack[] = array('CWPanel', array('id' => 'lisDetalle','detalleDe' => 'lis','tipoComprobacion' => 'envio','action' => 'operarBD','method' => 'post','estado' => 'on','claseManejadora' => 'PedidoDetalle')); $_block_repeat=true;smarty_block_CWPanel($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		...
		<?php $this->_tag_stack[] = array('CWContenedor', array()); $_block_repeat=true;smarty_block_CWContenedor($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>			
			<?php $this->_tag_stack[] = array('CWTabla', array('conCheck' => 'true','id' => 'TablaDetalle','numFilasPantalla' => '6','datos' => $this->_tpl_vars['smty_datosTablaD'])); $_block_repeat=true;smarty_block_CWTabla($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
				<?php $this->_tag_stack[] = array('CWFila', array('tipoListado' => 'false')); $_block_repeat=true;smarty_block_CWFila($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
					<?php echo smarty_function_CWCampoTexto(array('textoAsociado' => "Nombre de artículo",'nombre' => 'lis_nombre','size' => '40','editable' => 'true','value' => $this->_tpl_vars['defaultData_PedidoDetalle']['nombre'],'dataType' => $this->_tpl_vars['dataType_PedidoDetalle']['nombre']), $this);?>

					<?php echo smarty_function_CWCampoTexto(array('textoAsociado' => 'Unidades','nombre' => 'lis_unidad','size' => '4','editable' => 'true','value' => $this->_tpl_vars['defaultData_PedidoDetalle']['lis_unidad'],'dataType' => $this->_tpl_vars['dataType_PedidoDetalle']['lis_unidad']), $this);?>
					...
					<?php echo smarty_function_CWCampoTexto(array('textoAsociado' => 'Precio total','nombre' => 'lis_precioTotal','size' => '7','editable' => 'true','value' => $this->_tpl_vars['defaultData_PedidoDetalle']['lis_precioTotal'],'dataType' => $this->_tpl_vars['dataType_PedidoDetalle']['lis_precioTotal']), $this);?>
