 ...
 include 'igep/include/gvHidraMaps.php';
	...
	class ComponentesMap extends gvHidraMaps {
		...
		function ComponentesMap () {
			...
			/*Debugger*/
			$this->_AddMapping('Debugger__iniciarVentana', 'Debugger');
			$this->_AddForward('Debugger__iniciarVentana', 'gvHidraSuccess', 'index.php?view=views/Debugger/p_Debugger.php&panel=buscar');
			$this->_AddForward('Debugger__iniciarVentana', 'gvHidraError', 'index.php?view=views/Debugger/p_Debugger.php');

			$this->_AddMapping('Debugger__buscar', 'Debugger');
			$this->_AddForward('Debugger__buscar', 'gvHidraSuccess', 'index.php?view=views/Debugger/p_Debugger.php&panel=listar');
			$this->_AddForward('Debugger__buscar', 'gvHidraError', 'index.php?view=views/Debugger/p_Debugger.php');
			$this->_AddForward('Debugger__buscar', 'gvHidraNoData', 'index.php?view=views/Debugger/p_Debugger.php&panel=listar');
			
			$this->_AddMapping('Debugger__operarBD', 'Debugger');
			$this->_AddForward('Debugger__operarBD', 'gvHidraSuccess', 'index.php?view=views/Debugger/p_Debugger.php&panel=listar');
			$this->_AddForward('Debugger__operarBD', 'gvHidraError', 'index.php?view=views/Debugger/p_Debugger.php');
			
			$this->_AddMapping('Debugger__borrar', 'Debugger');
			$this->_AddForward('Debugger__borrar', 'gvHidraSuccess', 'index.php?view=views/Debugger/p_Debugger.php&panel=listar');
			$this->_AddForward('Debugger__borrar', 'gvHidraError', 'index.php?view=views/Debugger/p_Debugger.php');
			$this->_AddForward('Debugger__borrar', 'gvHidraNoData', 'index.php?view=views/Debugger/p_Debugger.php&panel=buscar');
			
			$this->_AddMapping('Debugger__cancelarTodo', 'Debugger');
			$this->_AddForward('Debugger__cancelarTodo', 'gvHidraSuccess', 'index.php?view=views/Debugger/p_Debugger.php');
			
			$this->_AddMapping('Debugger__cancelarEdicion', 'Debugger');
			$this->_AddForward('Debugger__cancelarEdicion', 'gvHidraSuccess', 'index.php?view=views/Debugger/p_Debugger.php&panel=listar');
			
			$this->_AddMapping('Debugger__editar', 'Debugger');
			$this->_AddForward('Debugger__editar', 'gvHidraSuccess', 'index.php?view=views/Debugger/p_Debugger.php&panel=editar');
			$this->_AddForward('Debugger__editar', 'gvHidraError', 'index.php?view=views/Debugger/p_Debugger.php&panel=listar');
			
			$this->_AddMapping('Debugger__nuevo', 'Debugger');
			$this->_AddForward('Debugger__nuevo', 'gvHidraSuccess', 'index.php?view=views/Debugger/p_Debugger.php&panel=listar');				
			
			$this->_AddMapping('Debugger__insertar', 'Debugger');
			$this->_AddForward('Debugger__insertar', 'gvHidraSuccess', 'index.php?view=views/Debugger/p_Debugger.php&panel=buscar');
			$this->_AddForward('Debugger__insertar', 'gvHidraError', 'index.php?view=views/Debugger/p_Debugger.php');
			
			$this->_AddMapping('Debugger__modificar', 'Debugger');
			$this->_AddForward('Debugger__modificar', 'gvHidraSuccess', 'index.php?view=views/Debugger/p_Debugger.php&panel=listar');
			$this->_AddForward('Debugger__modificar', 'gvHidraError', 'index.php?view=views/Debugger/p_Debugger.php');}}?>