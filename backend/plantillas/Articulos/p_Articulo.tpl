...
<!--*********** PANEL fil ******************-->
	{CWPanel id="fil" action="buscar" method="post" estado="$estado_fil"  claseManejadora="Articulo"}
		{CWBarraSupPanel titulo="Filtrar artículos"}
...
<!-- ****************** PANEL lis ***********************-->
	{CWPanel id="lis" action="borrar" method="post" estado="$estado_lis" claseManejadora="Articulo"}
		{CWBarraSupPanel titulo="Listado de Articulos"}
		...
		{CWContenedor}
			{CWTabla conCheck="true" conCheckTodos="true" id="Tabla1" numFilasPantalla="10" datos=$smty_datosTabla}
				{CWFila tipoListado="false"}
					{CWCampoTexto nombre="lis_idarticulo" oculto="true" value=$defaultData_Articulo.lis_idarticulo dataType=$dataType_Articulo.lis_idarticulo}
					...
					{CWAreaTexto textoAsociado="Descripcion" nombre="lis_descripcion" size="30" editable="true" visible="true" value=$defaultData_Articulo.lis_descripcion dataType=$dataType_Articulo.lis_descripcion}
					...
					{CWCampoTexto textoAsociado="Ruta de la imagen" nombre="lis_imagen" size="20" editable="true" visible="true" value=$defaultData_Articulo.lis_imagen dataType=$dataType_Articulo.lis_imagen}
					...
					{CWCampoTexto textoAsociado="Categoria" nombre="lis_categoria" size="20" editable="true" visible="true" value=$defaultData_Articulo.lis_categoria dataType=$dataType_Articulo.lis_categoria}
				{/CWFila}				
...
<!-- ****************** PANEL edi ***********************-->
	{CWPanel id="edi" tipoComprobacion="envio" action="$smty_operacionFichaArticulo" method="post" estado="$estado_edi" claseManejadora="Articulo"  accion=$smty_operacionFichaArticulo}
		{CWBarraSupPanel titulo="Mantenimiento de Articulos"}
			{CWBotonTooltip imagen="04" iconCSS="glyphicon glyphicon-refresh" titulo="Limpiar campos" funcion="limpiar" actuaSobre="ficha"}				
		{/CWBarraSupPanel}
		{CWContenedor}
			{CWFichaEdicion id="FichaEdicion" datos=$smty_datosFicha} 
				{CWFicha}
					...
					<table class="text" cellspacing="4" cellpadding="4" border="0">
						...
						<tr>
							<td>{CWAreaTexto textoAsociado="Descripcion" nombre="edi_descripcion" size="0" editable="true" visible="true" value=$defaultData_Articulo.edi_descripcion dataType=$dataType_Articulo.edi_descripcion}</td>
						</tr>
						<tr>
