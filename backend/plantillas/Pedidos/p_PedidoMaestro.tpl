		...
		{CWContenedor}
			{CWTabla conCheck="true" conCheckTodos="false" id="Tabla1" numFilasPantalla="6" datos=$smty_datosTablaM}
				{CWFila tipoListado="false"}
					{CWCampoTexto textoAsociado="Fecha del pedido" nombre="lis_fecha" size="0" editable="true" visible="true" value=$defaultData_PedidoMaestro.lis_fecha  dataType=$dataType_PedidoMaestro.lis_fecha}
					...
					{CWCampoTexto textoAsociado="Nº DNI" nombre="lis_dni" size="9" editable="true" visible="true" value=$defaultData_PedidoMaestro.lis_dni  dataType=$dataType_PedidoMaestro.lis_dni}
					{CWCampoTexto textoAsociado="Cliente" nombre="lis_nombre" size="20" editable="true" visible="true" value=$defaultData_PedidoMaestro.lis_nombre  dataType=$dataType_PedidoMaestro.lis_nombre}

					{CWCampoTexto  nombre="lis_idpedido" oculto="true" value=$defaultData_PedidoMaestro.lis_idpedido  dataType=$dataType_PedidoMaestro.lis_idpedido}
				{/CWFila}				
	...
	{CWPanel id="lisDetalle" detalleDe="lis" tipoComprobacion="envio" action="operarBD" method="post" estado="on" claseManejadora="PedidoDetalle"}
		...
		{CWContenedor}			
			{CWTabla conCheck="true" id="TablaDetalle" numFilasPantalla="6" datos=$smty_datosTablaD}
				{CWFila tipoListado="false"}
					{CWCampoTexto textoAsociado="Nombre de artículo" nombre="lis_nombre" size="40" editable="true" value=$defaultData_PedidoDetalle.nombre dataType=$dataType_PedidoDetalle.nombre}
					{CWCampoTexto textoAsociado="Unidades" nombre="lis_unidad" size="4" editable="true" value=$defaultData_PedidoDetalle.lis_unidad dataType=$dataType_PedidoDetalle.lis_unidad}
					...
					{CWCampoTexto textoAsociado="Precio total" nombre="lis_precioTotal" size="7" editable="true" value=$defaultData_PedidoDetalle.lis_precioTotal dataType=$dataType_PedidoDetalle.lis_precioTotal}
				{/CWFila}				
				{CWPaginador enlacesVisibles="3" iconCSS="true"}
			{/CWTabla}	 		
		{/CWContenedor}
