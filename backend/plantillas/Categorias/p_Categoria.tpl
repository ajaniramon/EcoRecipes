		...
		{CWContenedor}
			{CWFicha}
				<table class="text" cellspacing="4" cellpadding="4" border="0">
					...
					<tr>
						<td>{CWCampoTexto textoAsociado="Nombre de la categor�a" nombre="fil_nombre" size="40" editable="true" visible="true" value=$defaultData_Categoria.fil_nombre dataType=$dataType_Categoria.fil_nombre}</td>
					</tr>
				</table>
				<br/>
			{/CWFicha}
		...
		{CWContenedor}
			{CWTabla conCheck="true" conCheckTodos="true" id="Tabla1" numFilasPantalla="10" datos=$smty_datosTabla}
				{CWFila tipoListado="false"}
					{CWCampoTexto textoAsociado="Nombre de la categor�a" nombre="lis_nombre" size="40" editable="true" visible="true" value=$defaultData_Categoria.lis_nombre dataType=$dataType_Categoria.lis_nombre}
				{CWCampoTexto  nombre="lis_idcategoria" oculto="true" value=$defaultData_Categoria.lis_idcategoria dataType=$dataType_Categoria.lis_idcategoria}
			...
			{CWFichaEdicion id="FichaEdicion" datos=$smty_datosFicha} 
				{CWFicha}
					...
					<table class="text" cellspacing="4" cellpadding="4" border="0">
						...
						<tr>
							<td>{CWCampoTexto textoAsociado="Nombre de la categor�a" nombre="edi_nombre" size="40" editable="true" visible="true" value=$defaultData_Categoria.edi_nombre dataType=$dataType_Categoria.edi_nombre}</td>
						</tr>
					</table>
					<br/>
				{/CWFicha}
