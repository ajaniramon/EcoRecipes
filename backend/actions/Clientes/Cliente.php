...
class Cliente extends gvHidraForm_DB
{
    public function __construct()
    {
        ...
        $this->addMatching("lis_contrasenya", "contrasenya", "cliente");
        $this->addMatching("lis_empleado", "empleado", "cliente");
        $this->addMatching("lis_enabled", "enabled", "cliente");
        /************************ END MATCHINGs ************************/


        /************************ TYPEs ************************/
        $int = new gvHidraInteger(false, 1);
        $this->addFieldType("lis_enabled", $int);
        ...
        $string = new gvHidraString(false, 40);
        $this->addFieldType('lis_contrasenya', $string);

        $string = new gvHidraString(false, 5);
        $this->addFieldType('lis_empleado', $string);
        ...
        $this->addDefaultData("lis_empleado", "false");
        $this->addDefaultData("lis_enabled", 1);
    ...
    {
        $objDatos->setValue("lis_contrasenya", "70be2932a9786b17a1351b8d3b9fdf22");
        $objDatos->setValue("lis_enabled", 1);
    ...
    {
        $dni = $objDatos->getValue("lis_dni");
        $query = <<<query
SELECT count(*) as "resultados" FROM pedido WHERE pedido.dni = "$dni"
query;
        $resultados = $this->consultar($query);
        $numero_resultados = intval($resultados[0]["resultados"]);
        if ($numero_resultados > 0) {
            $this->showMessage('APL-4');
            return -1;
        } else {
            return 0;
        }
